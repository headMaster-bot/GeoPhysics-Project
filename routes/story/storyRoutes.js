...
const { createStoryCtrl, getAllStoryCtrl, getStoryCtrl, getStoriesByEpicCtrl, updateStoryStatusCtrl, getStoriesByProjectCtrl, getProjectStoryStatsCtrl } = require('../../controllers/story/storyCtrl');
...
storyRoutes.get("/project-stats/:projectId", getProjectStoryStatsCtrl);
